...
function home(){
  ...
  app.innerHTML = `
    ...
    <p class="lede">Шесть тематических блоков — от русского языка до строительного надзора. Отвечайте, проверка сразу после каждого ответа, разбор ошибок в конце.</p>
    <div class="grid two">
      ${TESTS.map((t,k)=>{
        const sc = done[k];
